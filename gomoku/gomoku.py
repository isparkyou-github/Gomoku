...
def isCPUWin():
    ...
    count = 1
    for i in range(1, 5):
        if cpu_row + i < 9 and isBlack(cpu_row + i, cpu_col):
            count += 1
        else:
            break
    for i in range(-1, -5, -1):
        if cpu_row + i > 0 and isBlack(cpu_row + i, cpu_col):
            count += 1
        else:
            break
    if count >= 5:
    ...
    count = 1
    for i in range(1, 5):
        if cpu_col + i < 9 and isBlack(cpu_row, cpu_col + i):
            count += 1
        else:
            break
    for i in range(-1, -5, -1):
        if cpu_col + i > 0 and isBlack(cpu_row, cpu_col + i):
            count += 1
        else:
            break
    if count >= 5:
    ...
    count = 1
    for i in range(-1, -5, -1):
        if cpu_row + i > 0 and cpu_col + i < 9 and isBlack(cpu_row + i, cpu_col + i):
            count += 1
        else:
            break
    for i in range(1, 5,):
        if cpu_row + i < 9 and cpu_col + i > 0 and isBlack(cpu_row + i, cpu_col + i):
            count += 1
        else:
            break
    if count >= 5:
    ...
    count = 1
    for i in range(-1, -5, -1):
        if cpu_row + i > 0 and cpu_col + i > 0 and isBlack(cpu_row + i, cpu_col + i):
            count += 1
        else:
            break
    for i in range(1, 5,):
        if cpu_row + i < 9 and cpu_col + i < 9 and isBlack(cpu_row + i, cpu_col + i):
            count += 1
        else:
            break
    if count >= 5:
...
def cpuRound():
    ...
    youXiaCol = 1
    continueCount = 1
    while (player_row + zuoShangRow > 0 and player_col + zuoShangCol > 0
           and isBlack(player_row + zuoShangRow, player_col + zuoShangCol)):
        continueCount += 1
        zuoShangRow -= 1
        zuoShangCol -= 1
    while (player_row + youXiaRow < 9 and player_col + youXiaCol < 9
           and isBlack(player_row + youXiaRow, player_col + youXiaCol)):
        continueCount += 1
        youXiaRow += 1
        youXiaCol += 1
    if continueCount >= maxContinueCount:
    ...
    youShangCol = 1
    continueCount = 1
    while (player_row + zuoXiaRow < 9 and player_col + zuoXiaCol > 0
           and isBlack(player_row + zuoXiaRow, player_col + zuoXiaCol)):
        continueCount += 1
        zuoXiaRow += 1
        zuoXiaCol -= 1
    while (player_row + youShangRow > 0 and player_col + youShangCol < 9
           and isBlack(player_row + youShangRow, player_col + youShangCol)):
        continueCount += 1
        youShangRow -= 1
        youShangCol += 1
    if continueCount >= maxContinueCount:
